...
// ZeroTrustWorkloadIdentityManagerReconciler reconciles a ZeroTrustWorkloadIdentityManager object
...
// the ZeroTrustWorkloadIdentityManager object against the actual cluster state, and then
...
func (r *ZeroTrustWorkloadIdentityManagerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&operatoropenshiftiov1alpha1.ZeroTrustWorkloadIdentityManager{}).
		Complete(r)
}
