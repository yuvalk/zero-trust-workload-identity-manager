...
RUN CGO_ENABLED=0 GOOS=${TARGETOS:-linux} GOARCH=${TARGETARCH} go build -mod=mod -a -o manager cmd/zero-trust-workload-identity-manager/main.go

# Use distroless as minimal base image to package the manager binary
# Refer to https://github.com/GoogleContainerTools/distroless for more details
FROM registry.access.redhat.com/ubi9-minimal:9.4
WORKDIR /
COPY --from=builder /workspace/manager zero-trust-workload-identity-manager
USER 65532:65532
