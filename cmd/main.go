...
import (
	...
	"github.com/openshift/zero-trust-workload-identity-manager/internal/controller"
...
func main() {
	...
	if err = (&controller.ZeroTrustWorkloadIdentityManagerReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "ZeroTrustWorkloadIdentityManager")
		os.Exit(1)
	}
